...
import CustomerIntl from "./portal/CustomerIntl";
...
export default function App() {
  ...
  return <div className="portal">
    ...
    <main>
      {page==="customer"?<CustomerIntl navigate={navigate}/>:page==="tracking"?<Tracking/>:page==="capture"?<Capture/>:page==="dashboard"?<Dashboard/>:page==="privacy"?<section className="narrow"><ShieldCheck size={36}/><h1>{tx("privacy")}</h1><div className="panel"><h2>Aftercare privacy</h2><p>Name, email, phone, country, device information, issue description and the evidence you choose are associated with the case. Assisted collection can include screen recording, technical logs and device metadata.</p><p>Close personal conversations, passwords and documents before recording. Collection starts only after your authorization.</p></div></section>:<section className="narrow"><h1>404</h1><a href="/">{tx("back")}</a></section>}
    </main>
