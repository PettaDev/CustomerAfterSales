...
const text: Record<Lang, Record<string, string>> = {
  "pt-BR": {
    newCase: "Novo atendimento", myCase: "Meu caso", tfae: "Área TFAE", teamAccess: "Área da equipe / TFAE", developerCredit: "Desenvolvido por Gustavo Petta - TL & TFAE at Transsion", privacy: "Privacidade", language: "Idioma", mainNavigation: "Navegação principal", supportLabel: "SUPORTE AO CLIENTE", footerSupport: "Pós-venda e suporte ao cliente",
  ...
  en: {
    newCase: "New case", myCase: "My case", tfae: "TFAE area", teamAccess: "Team area / TFAE", developerCredit: "Developed by Gustavo Petta - TL & TFAE at Transsion", privacy: "Privacy", language: "Language", mainNavigation: "Main navigation", supportLabel: "CUSTOMER SUPPORT", footerSupport: "After-sales customer support",
  ...
  "es-419": {
    newCase: "Nuevo caso", myCase: "Mi caso", tfae: "Área TFAE", teamAccess: "Área del equipo / TFAE", developerCredit: "Desarrollado por Gustavo Petta - TL & TFAE at Transsion", privacy: "Privacidad", language: "Idioma", mainNavigation: "Navegación principal", supportLabel: "SOPORTE AL CLIENTE", footerSupport: "Posventa y soporte al cliente",
  ...
  "zh-CN": {
    newCase: "新建服务单", myCase: "我的服务单", tfae: "TFAE 工作区", teamAccess: "团队区域 / TFAE", developerCredit: "由 Gustavo Petta 开发 - Transsion TL & TFAE", privacy: "隐私", language: "语言", mainNavigation: "主导航", supportLabel: "客户支持", footerSupport: "售后客户支持",
