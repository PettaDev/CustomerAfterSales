...
const text: Record<Lang, Record<string, string>> = {
  ...
  "es-419": {
    ...
    warrantyCheckTitle: "Posible garantía", warrantyCheckText: "¿Crees que el dispositivo todavía puede estar dentro de la garantía? Esto no aprueba la cobertura automáticamente; solo ayuda a preparar la revisión.", warrantyYes: "Sí", warrantyUnsure: "No estoy seguro", warrantyNo: "No", deviceIdentifier: "IMEI o número de serie", deviceIdentifierHelp: "Opcional. Si el dispositivo no enciende, puedes encontrar este número en la caja o en el comprobante de compra.", purchaseDate: "Fecha de compra", purchaseDateHelp: "Opcional. Indícala si la conoces; una fecha aproximada también ayuda al soporte a preparar la validación.", proofPurchaseHelp: "Si tienes factura o comprobante de compra, puedes adjuntar una foto junto con las evidencias de hardware. La cobertura sigue sujeta a validación del soporte.",
