const COPY = {
  "pt-BR": {
    subject: "Seu código de acesso ao Aftercare",
    title: "Código de acesso",
    intro: "Use este código para acessar a área interna do Aftercare:",
  ...
  en: {
    subject: "Your Aftercare access code",
    title: "Access code",
    intro: "Use this code to access the internal Aftercare workspace:",
  ...
  "es-419": {
    subject: "Tu código de acceso a Aftercare",
    title: "Código de acceso",
    intro: "Usa este código para acceder al área interna de Aftercare:",
    expires: "El código vence en 10 minutos y solo puede usarse una vez.",
    ignore: "Si no solicitaste este acceso, ignora este correo.",
  },
  "zh-CN": {
    subject: "您的 Aftercare 访问验证码",
    title: "访问验证码",
    intro: "请使用此验证码进入 Aftercare 内部工作区：",
